...
STEER_CMD_MIN = -130                # servo command at full left lock
STEER_CMD_MAX = 130              # servo command at full right lock
STEER_MAX_LEFT_DEG = 30.0        # MEASURE: real wheel angle at full left
STEER_MAX_RIGHT_DEG = 20.0        # MEASURE: real wheel angle at full right
...
LIDAR_USE_FRONT_HALF_ONLY = False  # True discards everything behind the car
...
DRIVE_MIN_SPEED = 180            # motor needs at least 100 to push the car smoothly
...
FRONT_OBSTACLE_MM = 700          # EXACTLY 60cm for front triggering
SIDE_OBSTACLE_MM = 500           # EXACTLY 40cm for left/right triggering
ESCAPE_REVERSE_MM = 500          # Safe Mode: If closer than 25cm to front, go backward!
...
class Driver:
    ...
    def _decide(self, view, pillar):
        ...
        # 2. Cornering (Front detection at exact parameter setting)
        ...
        # 3. A fresh, confident, close pillar: the camera steers.
